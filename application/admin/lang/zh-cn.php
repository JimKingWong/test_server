...
return [
    ...
    'Register'                                              => '注册',
    'User Center'                                           => '会员中心',
    'Please input the verification code'                    => '请输入谷歌验证码',
    'Verification code error'                               => '验证码错误',
    'Google verification code'                              => '谷歌验证码',
    '已绑定谷歌验证器的管理员请填写'                         => '已绑定谷歌验证器的管理员请填写',
    'Bind successful'                                       => '绑定成功',
    'Unbind successful'                                     => '解绑成功',
    'Bind failed, please try again'                         => '绑定失败，请重试',
    'Unbind failed, please try again'                       => '解绑失败，请重试',
