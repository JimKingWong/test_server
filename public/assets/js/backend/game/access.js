define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'game/access/index' + location.search,
                    add_url: 'game/access/add',
                    edit_url: 'game/access/edit',
                    del_url: 'game/access/del',
                    multi_url: 'game/access/multi',
                    import_url: 'game/access/import',
                    table: 'game_access',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'game/access/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
